...
export const startWizardSession = (
  body: StartWizardSessionBody,
...
export const advanceWizardSession = (
  sessionId: string,
  fromStepId: string,
  draft: WizardState,
): Promise<WizardSessionResponse> => {
...
export const backWizardSession = (sessionId: string): Promise<WizardSessionResponse> => {
...
export const finalizeWizardSession = (
  sessionId: string,
  draft: WizardState,
...
export const abandonWizardSession = async (sessionId: string): Promise<void> => {
