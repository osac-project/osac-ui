...
const GLOBAL_ITEMS: CatalogItem[] = [
  ...
  { id: 'vm-ubuntu22-s',name: 'Ubuntu 22 — Small',    template: 'vm-ubuntu22',  variant: 'S',    cpu: 2,  ram: 8,   presets: 3, published: true  },
  { id: 'vm-win2022-m', name: 'Windows 2022 — Medium', template: 'vm-win2022',  variant: 'M',    cpu: 4,  ram: 16,  presets: 4, published: false },
]
    ...
    <PageSection isFilled>
      ...
      >
        ...
        <ModalBody className={modalBodyCss}>
          <PublishCatalogItemWizard backingTemplates={BACKING_TEMPLATES} onDone={() => setPublishOpen(false)} />
        </ModalBody>
      </Modal>
    </PageSection>
  )
